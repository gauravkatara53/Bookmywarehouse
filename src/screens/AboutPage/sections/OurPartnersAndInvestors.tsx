...
export default function OurPartnersAndInvestors() {
  return (
    <div 
      ...
      className="flex flex-col gap-4 bg-cover items-center lg:mx-32 md:mx-16 sm:mx-8 mx-4 p-8 sm:p-16 rounded-[7rem] sm:rounded-[2rem] md:rounded-[7rem]"
    >
      ...
      <div className="flex flex-col sm:flex-row text-2xl sm:text-6xl justify-between w-full text-white gap-4">
