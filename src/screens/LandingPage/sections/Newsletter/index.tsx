...
export default function Newsletter() {
  return (
    <div style={{backgroundImage:'url(newsletter-bg.png)'}} className="mx-32 bg-no-repeat bg-center  w-[85%] bg-cover hidden xl:flex flex-col items-center justify-center h-[23rem] rounded-[2rem]">
